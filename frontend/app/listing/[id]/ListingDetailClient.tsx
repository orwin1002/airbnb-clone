...
export default function ListingDetailClient({ id }: Props) {
  ...
  return (
    <main className="mx-auto max-w-[1120px] px-6 py-6 md:px-10 md:py-8">
      <h1 className="mb-2 text-[26px] font-semibold leading-tight tracking-tight md:text-[28px]">{listing.title}</h1>
